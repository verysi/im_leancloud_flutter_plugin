...
import com.sisi.imleancloudplugin.handler.LCIMClientEventHandler;
import com.sisi.imleancloudplugin.handler.LCIMConversationHandler;
import com.sisi.imleancloudplugin.handler.LCIMMessageHandler;
...
public final class LCChatKit {
    ...
    public void init(Context context, String appId, String appKey) {
        ...
        //PushService.setDefaultChannelId(context.getApplicationContext(), "default");
